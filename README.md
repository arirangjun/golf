...
| 규칙 | 설명 |
|------|------|
| 회원 예약 | 오픈 주간(월~일) 내 **기본 1회**. 과거 시간은 불가 |
| 당일 추가 | **오늘** 빈 슬롯 **추가 1회** (주간 기본 1회와 별도) |
| 익일 추가 | **21:00 이후** 내일 잔여 슬롯 **추가 1회** (주간 기본 1회와 별도) |
| 예약 오픈 | 주중(월~금): 이번 주(월~일) 상시 예약 · 주말: 토요일 14:00에 다음 주 오픈 |
| 회원 취소 | 예약 3시간 전까지만 취소 가능 |
| 관리자 | **모든 시간** 예약·취소 가능 (과거 포함, 주간 제한 없음) |
| 운영 시간 | 00:00 ~ 24:00 (1시간 단위, 24슬롯) |
| 데이터 보관 | 예약 자료 **1년** 조회·보관, 이후 **자동 삭제** |
